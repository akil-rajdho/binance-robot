...
export default function AlgorithmReasoning() {
  ...
  return (
    <div className="rounded-xl border border-[#1E2A3D] bg-[#111827] shadow-lg">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-[#1E2A3D] px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {lastUpdated && (
            <span className="text-xs text-[#4b5563]">{lastUpdated.toLocaleTimeString()}</span>
          )}
        </div>
      </div>
